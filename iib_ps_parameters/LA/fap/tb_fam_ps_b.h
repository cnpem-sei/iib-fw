...
#ifndef TB_FAM_PS_B_H_
#define TB_FAM_PS_B_H_
...
#define FAP_OUTPUT_OVERVOLTAGE_ALM_LIM          20.0
#define FAP_OUTPUT_OVERVOLTAGE_ITLK_LIM         23.0
...
#define FAP_GROUND_LEAKAGE_ALM_LIM              0.300
