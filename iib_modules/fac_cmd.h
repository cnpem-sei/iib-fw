...
//FAC Giga de Testes Novo CMD

#ifdef FAC_GIGA_TESTE_NOVO__CMD

#include <iib_ps_parameters/development/fac/fac_giga_teste_novo__cmd.h>

#endif /* FAC_GIGA_TESTE_NOVO__CMD */
